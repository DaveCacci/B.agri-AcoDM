...
/*Connect equations*/
  ...
  model Chile_OL_MPC
    ...
    digester.trapezoid.offset = fake_theta_reduction, comp_maize.fileName = LibraryPath + "\\CombiTimeTables\\Chile\\disturbance_maize.txt", comp_tomatosouce.fileName = LibraryPath + "\\CombiTimeTables\\Chile\\disturbance_tomatosauce.txt", comp_slurry.fileName = LibraryPath + "\\CombiTimeTables\\Chile\\disturbance_cowslurry.txt", tomatosouce.an = 0.05, comp_maize.timeScale = 1, comp_tomatosouce.timeScale = 1, comp_slurry.timeScale = 1) annotation(
      Placement(visible = true, transformation(origin = {44, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    /*Additional declarations*/
    BlockLibrary.Pump_onoff pump_onoff(impulse = impulse) annotation(
      Placement(visible = true, transformation(origin = {-6, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
