package ADM1
  record ParametersADM1_operational
    parameter Real V_liq(unit = "m3") =  743 "7430*2; Single Digester usefull working volume";
    parameter Real V_gas(unit = "m3") = V_liq *0.5 "0.10884; Single Digester headspace as A*H-usefull working volume";
...
//S_hco3_in1 = Alk_mol_in1 - (S_ac_ion_in1 + S_pro_ion_in1 + S_bu_ion_in1 + S_va_ion_in1) "mol/L";
      S_hco3_in1 = Alk_mol_in1 - (S_ac_ion_in1 + S_pro_ion_in1 + S_bu_ion_in1 + S_va_ion_in1) - S_oh_in1 - (Manure_Out.S_in - S_nh4_in1) + S_h_in1 "mol/L";
...
//S_hco3_in2 = Alk_mol_in2 - (S_ac_ion_in2 + S_pro_ion_in2 + S_bu_ion_in2 + S_va_ion_in2) "mol/L";
      S_hco3_in2 = Alk_mol_in2 - (S_ac_ion_in2 + S_pro_ion_in2 + S_bu_ion_in2 + S_va_ion_in2) - S_oh_in2 - (Slurry_Out.S_in - S_nh4_in2) + S_h_in2 "mol/L";
...
//S_hco3_in3 = Alk_mol_in3 - (S_ac_ion_in3 + S_pro_ion_in3 + S_bu_ion_in3 + S_va_ion_in3) "mol/L";
      S_hco3_in3 = Alk_mol_in3 - (S_ac_ion_in3 + S_pro_ion_in3 + S_bu_ion_in3 + S_va_ion_in3) - S_oh_in3 - (MaizeSilage_Out.S_in - S_nh4_in3) + S_h_in3 "mol/L";
...
//INORGANIC CARBON COEFFICIENTS ON PROCESSES
      ...
      v13 = (-C_bac) + C_pr*f_pr_xb+C_ch*f_ch_xb+C_li*f_li_xb+C_xi*f_xi_xb;
//RATES
...
//Soluble matter
      ...
      24 * 3600 * der(S_in) = FeedMix_In.Q / V_liq * (FeedMix_In.S_in - S_in) - Y_su * N_bac * r5 + (N_aa - Y_aa * N_bac) * r6 - Y_fa * N_bac * r7 - Y_c4 * N_bac * r8 - Y_c4 * N_bac * r9 - Y_pro * N_bac * r10 - Y_ac * N_bac * r11 - Y_h2 * N_bac * r12 + (N_bac - N_i*f_xi_xb - N_aa*f_pr_xb) * (r13 + r14 + r15 + r16 + r17 + r18 + r19) "+(N_xc - FeedMix_In.f_xi_xc * N_i - FeedMix_In.f_si_xc * N_i - FeedMix_In.f_pr_xc * N_aa) * r1";
//Biomasses
...
//Inorganic Nitrogen Balance
      ...
      IN_balance_out = Digestate_Out.Q * (S_in + N_i * (S_i + X_i) + N_aa * (S_aa + X_pr) + N_bac * (X_su + X_aa + X_fa + X_c4 + X_pro + X_ac + X_h2)) "+N_xc * X_c";
    ...
    model Sludge_Discharge
      ...
      Modelica.Blocks.Interfaces.RealOutput OutDig[1] annotation(
        Placement(visible = true, transformation(origin = {98, -6}, extent = {{-16, -16}, {16, 16}}, rotation = 0), iconTransformation(origin = {110, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
...
//Alk = (Digestate_In.S_hco3 + Digestate_In.S_oh + Digestate_In.S_acm / Ac_conv + Digestate_In.S_prom / Pro_conv + Digestate_In.S_bum / Bu_conv + Digestate_In.S_vam / Va_conv) * 50 * 1000 "Alkalinity as mgCaCO3/L";
      Alk = (Digestate_In.S_hco3 + Digestate_In.S_oh + Digestate_In.S_acm / Ac_conv + Digestate_In.S_prom / Pro_conv + Digestate_In.S_bum / Bu_conv + Digestate_In.S_vam / Va_conv - Digestate_In.S_h + Digestate_In.S_nh3) * 50 * 1000 "Alkalinity as mgCaCO3/L";
  ...
  class SynopticModel
    ADM1.BlockLibrary.Feed_Source_1 CattleManure annotation(
      Placement(visible = true, transformation(origin = {-126, 56}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ADM1.BlockLibrary.Feed_Source_2 CattleSlurry annotation(
  ...
  equation
    ...
    connect(digester.Digestate_Out, Discharge.Digestate_In) annotation(
      Line(points = {{30, 6.5}, {42.5, 6.5}, {42.5, 6}, {47, 6}}));
    ...
    connect(CattleManure.Manure_Out, feeding_Tank.Manure_In) annotation(
      Line(points = {{-118, 50}, {-86, 50}, {-86, 36}}));
    connect(MaizeSilage.MaizeSilage_Out, feeding_Tank.MaizeSilage_In) annotation(
      Line(points = {{-111, -13}, {-86, -13}, {-86, 10}}));
  protected
    annotation(
