...
//Slurry_Out.S_an = S_an_input2 "mol/L";
    ...
    //Slurry_Out.S_cat = (-S_nh4_in2) - S_h_in2 + Slurry_Out.S_an + S_hco3_in2 + S_oh_in2 + S_ac_ion_in2 + S_pro_ion_in2 + S_bu_ion_in2 + S_va_ion_in2 + 2 * S_hpo4_in2 + S_h2po4_in2 + 3 * S_po4_in2 + 0.021 "mol/L";
...
//Activity coefficients calculation
      g_mono = 10 ^ (-0.51 * z_h ^ 2 * (I ^ 0.5 / (1 + I ^ 0.5) - 0.24 * I));
      g_bi = 10 ^ (-0.51 * z_ca ^ 2 * (I ^ 0.5 / (1 + I ^ 0.5) - 0.24 * I));
      g_tri = 10 ^ (-0.51 * z_po4 ^ 2 * (I ^ 0.5 / (1 + I ^ 0.5) - 0.24 * I));
