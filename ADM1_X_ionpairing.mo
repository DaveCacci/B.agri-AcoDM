package ADM1_P
  ...
  record StateVariablesADM1_pc
    ...
    //
    Types.MolarDensity_M S_cahpo4(fixed = false, start = 1.46E-06, nominal = 1e-14) "8/10";
    Types.MolarDensity_M a_cahpo4(fixed = false, start = 1.46E-06, nominal = 1e-14) "8/10";
    //
    ...
    Real Ka_cahpo4(fixed = false, start = 2.14e-2);
    Real Ka_cahco3(fixed = false, start = 2.14e-2);
    //Process rates
...
<p> Last review: <em> December 06, 2020 </em></p></html>"));
  ...
  record ParametersADM1_physiochemical
    ...
    final parameter Real pKa_h2po4 = -19.573 "-log10kaH2PO4";
    final parameter Real pKa_hpo4 = - 12.375 "-log10kaHPO4";
    final parameter Real pKa_h3po4 = - 21.72 "-log10kaH3PO4";
    final parameter Real pKa_cahco3 = -11.434;
    final parameter Real pKa_cahpo4 = -15.035;
    final parameter Real pKa_mghco3 = -11.34;
    final parameter Real pKa_mghpo4 = -15.175;
    ...
    constant Real deltaH0_Ka_h2po4(unit = "J/mol") = -18000 "enthalpy of reaction H2PO4->HPO4. To be verified!";
    constant Real deltaH0_Ka_hpo4(unit = "J/mol") = -15000 "enthalpy of reaction HPO4->PO4. To be verified!";
    constant Real deltaH0_Ka_h3po4(unit = "J/mol") = -10500 "enthalpy of reaction H3PO4->H2PO4. To be verified!";
    constant Real deltaH0_Ka_cahco3(unit = "J/mol") = 0 "enthalpy of reaction H3PO4->H2PO4. To be verified!";
    constant Real deltaH0_Ka_cahpo4(unit = "J/mol") = -3000 "enthalpy of reaction H3PO4->H2PO4. To be verified!";
    constant Real deltaH0_Ka_mghco3(unit = "J/mol") = -9600 "enthalpy of reaction H3PO4->H2PO4. To be verified!";
    constant Real deltaH0_Ka_mghpo4(unit = "J/mol") = -3000 "enthalpy of reaction H3PO4->H2PO4. To be verified!";
...
//Computation of ionic components
      ...
      outlet.S_cat = if weender == true then 0 else (-S_nh4) - S_h - 2*outlet.S_ca - 2*outlet.S_mg + outlet.S_an + S_hco3 + S_oh + S_acm + S_prom + S_bum + S_vam + 2*S_hpo4 + S_h2po4 + 3*S_po4 + other_cat_an "mol/L";
...
//
    ...
    //Acidity constants with temperature correction
      ...
      Ka_nh4 = 10^(-pKa_nh3)*exp(deltaH0_Ka_nh4/(R*100)*(1/T_ref - 1/T_op))*convKa "NH4+ acidity constant with temperature correction - unit = M";
      Ka_h2o = 10^(-pKa_h2o)*exp(deltaH0_Ka_h2o/(R*100)*(1/T_ref - 1/T_op))*convKa "water acidity constant with temperature correction - unit = M^2";
      Ka_h2po4 = 10^(-pKa_h2po4 - deltaH0_Ka_h2po4/(2.303*R*100)*(1/T_ref - 1/T_op))*convKa "H2PO4 acidity constant with temperature correction - unit = M";
      Ka_hpo4 = 10^(-pKa_hpo4 - deltaH0_Ka_hpo4/(2.303*R*100)*(1/T_ref - 1/T_op))*convKa "HPO4 acidity constant with temperature correction - unit = M";
      Ka_h3po4 = 10^(-pKa_h3po4 - deltaH0_Ka_h3po4/(2.303*R*100)*(1/T_ref - 1/T_op))*convKa "H3PO4 acidity constant with temperature correction - unit = M";
      Ka_cahco3 = 10^(-pKa_cahco3)*exp(deltaH0_Ka_cahco3/(R*100)*(1/T_ref - 1/T_op))*convKa "H3PO4 acidity constant with temperature correction - unit = M";
      Ka_cahpo4 = 10^(-pKa_cahpo4)*exp(deltaH0_Ka_cahpo4/(R*100)*(1/T_ref - 1/T_op))*convKa "H3PO4 acidity constant with temperature correction - unit = M";
    //I calculation
    ...
    //  a_h2po4 = S_ip*a_h^2*Ka_h3po4/(a_h^3 + Ka_h3po4/g_mono*a_h^2 + Ka_h3po4*Ka_h2po4/g_bi*a_h + Ka_h3po4*Ka_h2po4*Ka_hpo4/g_tri);
      ...
      //
      a_hpo4 = a_h*a_po4*Ka_hpo4;
      a_h2po4 = a_h^2*a_po4*Ka_h2po4;
      //
      a_cahpo4 = a_h*a_ca*a_po4*Ka_cahpo4;
    ...
    //S_oh = Ka_h2o * convKa / S_h;
      S_ca = a_ca/g_bi + a_h*a_ca*a_po4*Ka_cahpo4;
      S_ip = a_po4/g_tri + a_h^3*a_po4*Ka_h3po4 + a_h^2*a_po4*Ka_h2po4/g_mono + a_h*a_po4*Ka_hpo4/g_bi + a_h*a_ca*a_po4*Ka_cahpo4; 
      Theta = S_cat + S_nh4 + 2*a_ca/g_bi + 2*S_mg - S_hco3 - S_acm/Ac_conv - S_prom/Pro_conv - S_bum/Bu_conv - S_vam/Va_conv - S_an - 2*S_hpo4 - S_h2po4 - 3*S_po4 - 2*S_co3;
    //Theta=0;
...
//Block variables
    ...
    package Decomposed
      ...
      //Acidity constants with temperature correction
        ...
        Ka_nh4 = 10^(-pKa_nh3)*exp(deltaH0_Ka_nh4/(R*100)*(1/T_ref - 1/T_op))*convKa "NH4+ acidity constant with temperature correction - unit = M";
        Ka_h2o = 10^(-pKa_h2o)*exp(deltaH0_Ka_h2o/(R*100)*(1/T_ref - 1/T_op))*convKa "water acidity constant with temperature correction - unit = M^2";
        Ka_h2po4 = 10^(-pKa_h2po4 - deltaH0_Ka_h2po4/(2.303*R*100)*(1/T_op - 1/T_ref))*convKa "H2PO4 acidity constant with temperature correction - unit = M";
        Ka_hpo4 = 10^(-pKa_hpo4 - deltaH0_Ka_hpo4/(2.303*R*100)*(1/T_op - 1/T_ref))*convKa "HPO4 acidity constant with temperature correction - unit = M";
        Ka_h3po4 = 10^(-pKa_h3po4 - deltaH0_Ka_h3po4/(2.303*R*100)*(1/T_op - 1/T_ref))*convKa "H3PO4 acidity constant with temperature correction - unit = M";
        Ka_cahco3 = 10^(-pKa_cahco3)*exp(deltaH0_Ka_cahco3/(R*100)*(1/T_ref - 1/T_op))*convKa "H3PO4 acidity constant with temperature correction - unit = M";
        Ka_cahpo4 = 10^(-pKa_cahpo4)*exp(deltaH0_Ka_cahpo4/(R*100)*(1/T_ref - 1/T_op))*convKa "H3PO4 acidity constant with temperature correction - unit = M";
      //I calculation
        I = 0.5*(S_ca*2^2 + S_po4*3^2 + S_nh4*1^2 + S_mg*2^2 + S_hpo4*2^2 + S_h2po4*1^2 + S_hco3*1^2 + S_cat*1^2 + S_an*1^2 + S_co3*2^2 + 1^2*(S_acm/Ac_conv + S_prom/Pro_conv + S_bum/Bu_conv + S_vam/Va_conv));
...
//
  ...
  model Test_MPP
    ...
    extends ADM1_P.ParametersADM1_operational;
    extends ADM1_P.ParametersADM1_conversion;
    ADM1_P.BlockLibrary.Decomposed.MPP_input mPP_input(precipitation = false) annotation(
    ...
    BlockLibrary.Decomposed.pH_batch_input PH(I(fixed = false, start = 0.12), S_h(fixed = true, start = 7e-8), a_h(fixed = false, start = 7e-9), g_mono(fixed = false, start = 0.76), ideality = false) annotation(
