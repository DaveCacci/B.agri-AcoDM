package ADM1
  record ParametersADM1_operational
    parameter Real V_liq(unit = "m3") =  7430*2 "Single Digester usefull working volume";
    parameter Real V_gas(unit = "m3") = V_liq *0.10884 "Single Digester headspace as A*H-usefull working volume";
    ...
    parameter Real T_op_mean(unit = "K") = 315.15 "Mean operative temperature";
...
model Feed_Source_1
  ...
  ADM1.Interfaces.Feed Manure_Out annotation(
...
//Computation of variables X_ch, X_pr, X_li (gCOD/L; Biernacki)
  ...
  tCOD_in1 = COD_VFA_in1 + Manure_Out.X_c "gCOD/L, total COD as sum of total CH, PR, LI and VFA";
...
//Computation of ionic components
  ...
  Manure_Out.S_cat = (-S_nh4_in1) - S_h_in1 + Manure_Out.S_an + S_hco3_in1 + S_oh_in1 + S_ac_ion_in1 + S_pro_ion_in1 + S_bu_ion_in1 + S_va_ion_in1 "mol/L";
...
Diagram(graphics = {Rectangle(extent = {{-66, 2}, {-66, 2}})}));
    ...
    model Feed_Source_2
      ...
      ADM1.Interfaces.Feed Slurry_Out annotation(
...
//Computation of variables X_ch, X_pr, X_li (gCOD/L; Biernacki)
      ...
      tCOD_in2 = COD_VFA_in2 + Slurry_Out.X_c "gCOD/L, total COD as sum of total CH, PR, LI and VFA";
...
//Computation of ionic components
      ...
      S_hco3_in2 = Alk_mol_in2 - (S_ac_ion_in2 + S_pro_ion_in2 + S_bu_ion_in2 + S_va_ion_in2) "mol/L";
      ...
      Slurry_Out.S_cat = (-S_nh4_in2) - S_h_in2 + Slurry_Out.S_an + S_hco3_in2 + S_oh_in2 + S_ac_ion_in2 + S_pro_ion_in2 + S_bu_ion_in2 + S_va_ion_in2 "mol/L";
    ...
    model Feed_Source_3
      extends ADM1.Icons.FeedSource3;
      extends ADM1.ParametersADM1_operational;
      extends ADM1.ParametersADM1_conversion;
      extends ADM1.ParametersADM1_physiochemical;
      extends ADM1.OtherVariables_Feed3;
      ADM1.Interfaces.Feed MaizeSilage_Out annotation(
        Placement(visible = true, transformation(origin = {88, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {88, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
...
//Computation of variables X_ch, X_pr, X_li (gCOD/L; Biernacki)
    ...
    MaizeSilage_Out.X_ch=0.695*440.55;
      tCOD_in3 = COD_VFA_in3 + MaizeSilage_Out.X_c "gCOD/L, total COD as sum of total CH, PR, LI and VFA";
...
//Computation of ionic components
      ...
      S_hco3_in3 = Alk_mol_in3 - (S_ac_ion_in3 + S_pro_ion_in3 + S_bu_ion_in3 + S_va_ion_in3) "mol/L";
      ...
      MaizeSilage_Out.S_cat = (-S_nh4_in3) - S_h_in3 + MaizeSilage_Out.S_an + S_hco3_in3 + S_oh_in3 + S_ac_ion_in3 + S_pro_ion_in3 + S_bu_ion_in3 + S_va_ion_in3 "mol/L";
    ...
    model Feeding_Tank
      ...
      ADM1.Interfaces.Feed Manure_In annotation(
      ...
      ADM1.Interfaces.Feed Slurry_In annotation(
      ...
      ADM1.Interfaces.Feed MaizeSilage_In annotation(
      ...
      ADM1.Interfaces.Partial Partial_Out annotation(
        Placement(visible = true, transformation(origin = {78, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-72, -54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
...
//  MaizeSilage_In.f_li_xc = FeedMix_Out.f_li_xc;
      ...
      Partial_Out.Q=FeedMix_Out.Q;
      Partial_Out.f_ch1=-(Manure_In.X_ch * Manure_In.Q) / (FeedMix_Out.X_ch*FeedMix_Out.Q);
      Partial_Out.f_ch2=-(Slurry_In.X_ch * Slurry_In.Q) / (FeedMix_Out.X_ch*FeedMix_Out.Q);
      Partial_Out.f_ch3=-(MaizeSilage_In.X_ch * MaizeSilage_In.Q) / (FeedMix_Out.X_ch*FeedMix_Out.Q);
      Partial_Out.f_pr1=-(Manure_In.X_pr * Manure_In.Q) / (FeedMix_Out.X_pr*FeedMix_Out.Q);
      Partial_Out.f_pr2=-(Slurry_In.X_pr * Slurry_In.Q) / (FeedMix_Out.X_pr*FeedMix_Out.Q);
      Partial_Out.f_pr3=-(MaizeSilage_In.X_pr * MaizeSilage_In.Q) / (FeedMix_Out.X_pr*FeedMix_Out.Q);
      Partial_Out.f_li1=-(Manure_In.X_li * Manure_In.Q) / (FeedMix_Out.X_li*FeedMix_Out.Q);
      Partial_Out.f_li2=-(Slurry_In.X_li * Slurry_In.Q) / (FeedMix_Out.X_li*FeedMix_Out.Q);
      Partial_Out.f_li3=-(MaizeSilage_In.X_li * MaizeSilage_In.Q) / (FeedMix_Out.X_li*FeedMix_Out.Q);
    annotation(
        experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002),
        __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
        __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl"));end Feeding_Tank;
    ...
    model Digester
      ...
      ADM1.Interfaces.Partial Partial_In annotation(
        Placement(visible = true, transformation(origin = {-74, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-76, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
//Biochemical process rates
      r1 = k_dis * X_c;
      r2_1 = Partial_In.f_ch1*k_hyd_ch1_T * X_ch;
      r2_2 = Partial_In.f_ch2*k_hyd_ch2_T * X_ch;
      r2_3 = Partial_In.f_ch3*k_hyd_ch3_T * X_ch;
      r3_1 = Partial_In.f_pr1*k_hyd_pr1_T * X_pr;
      r3_2 = Partial_In.f_pr2*k_hyd_pr2_T * X_pr;
      r3_3 = Partial_In.f_pr3*k_hyd_pr3_T * X_pr;
      r4_1 = Partial_In.f_li1*k_hyd_li1_T * X_li;
      r4_2 = Partial_In.f_li2*k_hyd_li2_T * X_li;
      r4_3 = Partial_In.f_li3*k_hyd_li3_T * X_li;
...
//Particulate matter
      ...
      24 * 3600 * der(X_ch) = FeedMix_In.Q / V_liq * (FeedMix_In.X_ch - X_ch) + FeedMix_In.f_ch_xc * r1 - r2_1-r2_2-r2_3;
      24 * 3600 * der(X_pr) = FeedMix_In.Q / V_liq * (FeedMix_In.X_pr - X_pr) + FeedMix_In.f_pr_xc * r1 - r3_1-r3_2-r3_2;
      24 * 3600 * der(X_li) = FeedMix_In.Q / V_liq * (FeedMix_In.X_li - X_li) + FeedMix_In.f_li_xc * r1 - r4_1-r4_2-r4_3;
...
//Soluble matter
      ...
      24 * 3600 * der(S_ic) = FeedMix_In.Q / V_liq * (FeedMix_In.S_ic - S_ic) - (v1 * r1 + v2 * (r2_1+r2_2) + v3 * (r3_1+r3_2) + v4 * (r4_1+r4_2) + v5 * r5 + v6 * r6 + v7 * r7 + v8 * r8 + v9 * r9 + v10 * r10 + v11 * r11 + v12 * r12 + v13 * (r13 + r14 + r15 + r16 + r17 + r18 + r19)) - rt10;
...
// Carachteristics of digestate
    ...
    annotation(
        experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002),
        __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
        __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl"));end Probe_P;
  ...
  class SynopticModel
    ...
    ADM1.BlockLibrary.Feed_Source_3 MaizeSilage annotation(
  ...
  equation
  connect(feed_Source_1.Manure_Out, feeding_Tank.Manure_In) annotation(
      Line(points = {{-117, 49}, {-99.2, 49}, {-99.2, 36}, {-86, 36}}));
  connect(feed_Source_2.Slurry_Out, feeding_Tank.Slurry_In) annotation(
      Line(points = {{-108, 20}, {-86, 20}, {-86, 26}}));
  connect(MaizeSilage.MaizeSilage_Out, feeding_Tank.MaizeSilage_In) annotation(
      Line(points = {{-111, -13}, {-86, -13}, {-86, 10}}));
  ...
  connect(PID_Pgas.y, digester.u) annotation(
      Line(points = {{6, 72}, {12, 72}, {12, 46.5}}, color = {0, 0, 127}));
  ...
  connect(PID_Pgas.u_s, digester.P_gas) annotation(
      Line(points = {{-18, 72}, {-28, 72}, {-28, 52}, {8, 52}, {8, 46}}, color = {0, 0, 127}));
  connect(feeding_Tank.FeedMix_Out, digester.FeedMix_In) annotation(
      Line(points = {{-54, 10}, {-38, 10}, {-38, 33}, {-8, 33}}));
  connect(feeding_Tank.Partial_Out, digester.Partial_In) annotation(
      Line(points = {{-44, 10}, {-28, 10}, {-28, 33}, {-18, 33}}));
  protected
    annotation(
      __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl", maxIntegrationOrder = "1"),
      __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
      experiment(StartTime = 0, StopTime = 8.64e+06, Tolerance = 1e-06, Interval = 120),
  Diagram);
  end SynopticModel;
  annotation(
