...
//  rp1=0;
//  rp2=0;
      rp1 = kcryst_acp * X_acp * ((a_ca ^ 3 * a_po4 ^ 2 / Ksp_acp) ^ (1 / 5) - 1) ^ 2 * sign(SI_acp);
      rp2 = kcryst_stru * X_stru * ((a_nh4 * a_po4 * a_mg / Ksp_stru) ^ (1 / 3) - 1) ^ 2 * sign(SI_stru);
...
connect(MaizeSilage.MaizeSilage_Out, feeding_Tank.MaizeSilage_In) annotation(
  ...
  model Cremona
  SynopticModel synopticModel(digester.V_liq=3300*4, digester.V_gas=(26^2*7*3.14/4)*4-3300*4) annotation(
