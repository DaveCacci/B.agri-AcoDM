package ADM1
  ...
  record ParametersADM1_kinetic
    parameter Real k_dis(unit = "1/d") = 1.2 "1.2 complex particulate disintegration first order constant";
  ...
  record StateVariablesADM1
    //Biomass
    Real X_su(fixed = true, start = 0.171844477851955) "0.45364";
    Real X_aa(fixed = true, start = 0.61923061050481) "0.482186";
    Real X_fa(fixed = true, start = 0.176756083950276) "0.1002";
    Real X_c4(fixed = true, start = 0.236115793848027) "0.205457";
    Real X_pro(fixed = true, start = 0.0707860907968375) "0.00906";
    Real X_ac(fixed = true, start = 0.44625608307655) "0.414792";
    Real X_h2(fixed = true, start = 0.21027420887601) "0.1845";
    //Particulate substrate
    Real X_c(fixed = true, start = 0.188523943307974) "0.29881";
    Real X_i(fixed = true, start = 8.82083748012884) "14.105";
    Real X_ch(fixed = true, start = 0.493907425992654) "0.0276983";
    Real X_pr(fixed = true, start = 3.12771809418909) "2.706355984";
    Real X_li(fixed = true, start = 0.965732116587352) "0.00093818";
    //Soluble substrate
    Real S_i(fixed = true, start = 8.95946506102146e-07);
    Real S_su(fixed = true, start = 0.0430230761137466);
    Real S_aa(fixed = true, start = 0.146267901457183);
    Real S_fa(fixed = true, start = 0.178270201571595);
    Real S_va(fixed = true, start = 0) "8/10**";
    Real S_bu(fixed = true, start = 0.0223872727272727) "8/10**";
    Real S_pro(fixed = true, start = 0) "8/10**";
    Real S_ac(fixed = true, start = 0.0674112) "8/10**";
    Real S_vam(fixed = true, start = 0) "8/10";
    Real S_bum(fixed = true, start = 0.0222730428912437) "8/10";
    Real S_prom(fixed = true, start = 0) "8/10";
    Real S_acm(fixed = true, start = 0.0671114242792856) "8/10";
    //Inorganic soluble components
    Real S_h2(fixed = true, start = 9.71595541886631e-07);
    Real S_ch4(fixed = true, start = 0.035718304294732);
    Real S_ic(fixed = true, start = 0.103271599042417) "8/10";
    Real S_in(fixed = true, start = 0.0404285714285714) "8/10";
    Real S_cat(fixed = true, start = 0.0708801468406167);
    Real S_an(fixed = false, start = 0.020);
    Real S_hco3(fixed = false, start = 0.0894721774775659) "8/10";
    Real S_nh3(fixed = true, start = 0.000648487639882837) "8/10";
    Real S_nh4(fixed = false, start = 0.0397800837886886) "8/10";
    Real S_co2(fixed = true, start = 0.0137994215648506) "8/10";
    Real pH(fixed = false, start = 7.11);
    Real S_h(fixed = true, start = 7.76247116628689e-08) "8/10";
    Real S_oh(fixed = false, start = 3.08254016984734e-07) "8/10";
    Real Theta(fixed = false, start = 0.02);
    //Gas components
    Real S_gas_h2(fixed = false, start = 0.0000409814975443494);
    Real S_gas_ch4(fixed = true, start = 1.06438615874316);
    Real S_gas_co2(fixed = true, start = 0.0211180300722813);
...
//Inorganic Nitrogen Balance
    ...
    model Sludge_Discharge
      ...
      Modelica.Blocks.Interfaces.RealInput COD_BCA_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput COD_TKN_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput CH_tot_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput PR_tot_BCA_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput LI_tot_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput COD_SM_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput Hac_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput Hpro_exp annotation(
    ...
    Modelica.Blocks.Interfaces.RealInput Hbu_exp annotation(
    ...
    Modelica.Blocks.Interfaces.RealInput Hva_exp annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput PR_tot_TKN_exp annotation(
...
// Carachteristics of digestate
  ...
  ADM1.BlockLibrary.Probe_Alk probe_Alk annotation(
      Placement(visible = true, transformation(origin = {83, 23}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_NH4_kit probe_NH4_kit annotation(
      Placement(visible = true, transformation(origin = {91, 23}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_VFA probe_VFA annotation(
      Placement(visible = true, transformation(origin = {99, 23}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_COD_SM probe_COD_SM annotation(
      Placement(visible = true, transformation(origin = {77, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_COD_BCA probe_COD_BCA annotation(
      Placement(visible = true, transformation(origin = {83, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_COD_TKN probe_COD_TKN annotation(
      Placement(visible = true, transformation(origin = {89, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_CH_tot probe_CH_tot annotation(
      Placement(visible = true, transformation(origin = {95, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_PR_tot_TKN probe_PR_tot_TKN annotation(
      Placement(visible = true, transformation(origin = {101, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_PR_tot_BCA probe_PR_tot_BCA annotation(
      Placement(visible = true, transformation(origin = {101, -39}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));    
  ADM1.BlockLibrary.Probe_LI_tot probe_LI_tot annotation(
      Placement(visible = true, transformation(origin = {107, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_VS probe_VS annotation(
      Placement(visible = true, transformation(origin = {113, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_pH probe_pH annotation(
      Placement(visible = true, transformation(origin = {75, 23}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ADM1.BlockLibrary.Probe_SingleVFAs probe_SingleVFAs annotation(
      Placement(visible = true, transformation(origin = {107, 23}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  BlockLibrary.Probe_P Probe_P annotation(
      Placement(visible = true, transformation(origin = {-56, 72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.LimPID pid(k = 1.5,limitsAtInit = true, yMax = 10000, yMin = 0)  annotation(
  ...
  equation
    ...
    connect(digester.T_op, Probe_T.y_T) annotation(
      Line(points = {{-7.5, 8}, {-21, 8}, {-21, -2}}, color = {0, 0, 127}));
    ...
    connect(digester.Digestate_Out, Discharge.Digestate_In) annotation(
      Line(points = {{30, 6.5}, {42.5, 6.5}, {42.5, 8}, {55, 8}}));
    connect(probe_Alk.y_Alk, Discharge.Alk_exp) annotation(
      Line(points = {{84, 18}, {86, 18}, {86, 0}}, color = {0, 0, 127}));
    connect(probe_NH4_kit.y_NH4, Discharge.N_NH4kit_exp) annotation(
      Line(points = {{92, 18}, {90, 18}, {90, 0}}, color = {0, 0, 127}));
    connect(probe_VFA.y_VFA, Discharge.VFA_exp) annotation(
      Line(points = {{100, 18}, {94, 18}, {94, 0}}, color = {0, 0, 127}));
    connect(probe_pH.y_pH, Discharge.pH_exp) annotation(
      Line(points = {{76, 18}, {82, 18}, {82, 0}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_Hac_meas, Discharge.Hac_exp) annotation(
      Line(points = {{106, 18}, {98.5, 18}, {98.5, 0}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_HVa_meas, Discharge.Hva_exp) annotation(
      Line(points = {{108, 18}, {110, 18}, {110, 0}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_HBu_meas, Discharge.Hbu_exp) annotation(
      Line(points = {{108, 18}, {106, 18}, {106, 0}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_HPro_meas, Discharge.Hpro_exp) annotation(
      Line(points = {{106, 18}, {103, 18}, {103, 0}}, color = {0, 0, 127}));
    connect(probe_COD_SM.y_COD_SM, Discharge.COD_SM_exp) annotation(
      Line(points = {{78, -36}, {78, -26}, {79, -26}, {79, -15}}, color = {0, 0, 127}));
    connect(probe_COD_BCA.y_COD_BCA, Discharge.COD_BCA_exp) annotation(
      Line(points = {{84, -36}, {84, -26}, {83.5, -26}, {83.5, -15}}, color = {0, 0, 127}));
    connect(probe_COD_TKN.y_COD_TKN, Discharge.COD_TKN_exp) annotation(
      Line(points = {{90, -36}, {88, -36}, {88, -15}}, color = {0, 0, 127}));
    connect(probe_CH_tot.y_CH_tot, Discharge.CH_tot_exp) annotation(
      Line(points = {{96, -36}, {93, -36}, {93, -15}}, color = {0, 0, 127}));
    connect(probe_PR_tot_TKN.y_PR_tot_TKN, Discharge.PR_tot_TKN_exp) annotation(
      Line(points = {{102, -36}, {102, -15}}, color = {0, 0, 127}));
    connect(probe_PR_tot_BCA.y_PR_tot_BCA, Discharge.PR_tot_BCA_exp) annotation(
      Line(points = {{101, -43.5}, {98, -43.5}, {98, -15}}, color = {0, 0, 127}));
    connect(probe_LI_tot.y_LI_tot, Discharge.LI_tot_exp) annotation(
      Line(points = {{108, -36}, {106, -36}, {106, -15}}, color = {0, 0, 127}));
    connect(probe_VS.y_VS, Discharge.VS_exp) annotation(
      Line(points = {{114, -36}, {110.5, -36}, {110.5, -15}}, color = {0, 0, 127}));
    connect(probe_pH.y_pH, Discharge.pH_exp) annotation(
      Line(points = {{76, 18}, {82, 18}, {82, -2}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_HVa_meas, Discharge.Hva_exp) annotation(
      Line(points = {{108, 18}, {110, 18}, {110, -2}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_HBu_meas, Discharge.Hbu_exp) annotation(
      Line(points = {{108, 18}, {106, 18}, {106, -2}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_HPro_meas, Discharge.Hpro_exp) annotation(
      Line(points = {{106, 18}, {102, 18}, {102, -2}}, color = {0, 0, 127}));
    connect(probe_SingleVFAs.y_Hac_meas, Discharge.Hac_exp) annotation(
      Line(points = {{106, 18}, {98, 18}, {98, -2}}, color = {0, 0, 127}));
  ...
  connect(pid.y, digester.u) annotation(
      Line(points = {{-6, 66}, {12, 66}, {12, 46}}, color = {0, 0, 127}));
  connect(Probe_P.y_P, pid.u_m) annotation(
      Line(points = {{-46, 72}, {-42, 72}, {-42, 44}, {-18, 44}, {-18, 54}}, color = {0, 0, 127}));
  connect(digester.P_gas, pid.u_s) annotation(
      Line(points = {{8, 46}, {-34, 46}, {-34, 66}, {-30, 66}}, color = {0, 0, 127}));
  protected
    annotation(
