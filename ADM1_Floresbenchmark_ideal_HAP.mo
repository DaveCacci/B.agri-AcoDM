package ADM1_P
  record ParametersADM1_operational
    parameter Real V_liq(unit = "m3") = 3400 "SRT=19 o 20. Portata 190 m3/d. Single Digester usefull working volume";
    parameter Real V_gas(unit = "m3") = 100 "0.10884; Single Digester headspace as A*H-usefull working volume";
    ...
    parameter Real T_op_mean(unit = "K") = 35+273.15 "Mean operative temperature";
...
<p> Last review: <em> December 06, 2020 </em></p></html>"));
  ...
  record ParametersADM1_stoichiometric
    ...
    parameter Real N_i(unit = "kmolN/kgCOD") = 0.0043 "nitrogen content of inert COD: 6% on weight basis in benchmark ASM";
    parameter Real N_aa(unit = "kmolN/kgCOD") = 0.0079 "nitrogen content of amino acids";
    parameter Real N_bac(unit = "kmolN/kgCOD") = 0.0062 "nitrogen content of biomass: 8% on weight basis in benchmark ASM";
    parameter Real C_xc(unit = "kmolC/kgCOD") = 0.0 "carbon content of complex particulate COD";
    parameter Real C_xi(unit = "kmolC/kgCOD") = 0.0301 "carbon content of particulate inert COD";
    parameter Real C_si(unit = "kmolC/kgCOD") = 0.0301 "carbon content of soluble inert COD";
    parameter Real C_ch(unit = "kmolC/kgCOD") = 0.0313 "carbon content of carbohydrates";
    parameter Real C_pr(unit = "kmolC/kgCOD") = 0.0307 "carbon content of proteins";
    parameter Real C_li(unit = "kmolC/kgCOD") = 0.0219 "carbon content of lipids";
    parameter Real C_su(unit = "kmolC/kgCOD") = 0.0313 "carbon content of sugars";
    parameter Real C_aa(unit = "kmolC/kgCOD") = 0.0307 "carbon content of amino acids";
    parameter Real C_fa(unit = "kmolC/kgCOD") = 0.0214 "carbon content of long chain fatty acids";
    parameter Real C_va(unit = "kmolC/kgCOD") = 0.0240 "carbon content of valerate";
    parameter Real C_bu(unit = "kmolC/kgCOD") = 0.0250 "carbon content of butyrate";
    ...
    parameter Real C_bac(unit = "kmolC/kgCOD") = 0.0305 "carbon content of biomass: 8% on weight basis in benchmark ASM";
...
<p> Last review: <em> December 06, 2020 </em></p></html>"));
  ...
  record ParametersADM1_physiochemical
    ...
    parameter Real pKa_hpo4 = 12.67 "-log10kaH2PO4";
    ...
    constant Real deltaH0_Ksp_hap(unit = "J/mol") = 0 "enthalpy of reaction of calcium phosphate formation??; 310 g/mol*26.1 J/g = 8091 J/mol";
    ...
    parameter Real pKsp_hap(unit = "conc") = 44.333 "New value from PCM?";
    parameter Real kcryst_hap(unit = "d-1") = 0.001 * (24 * 60);
    annotation(
...
<p> Last review: <em> December 06, 2020 </em></p></html>"));
  ...
  record StateVariablesADM1
    //Biomass
    Real X_su(fixed = true, start = 1.60571) "0.45364";
    Real X_aa(fixed = true, start = 0.541365) "0.482186";
    Real X_fa(fixed = true, start = 0.213571) "0.1002";
    Real X_c4(fixed = true, start = 0.412867) "0.205457";
    Real X_pro(fixed = true, start = 0.248744) "0.00906";
    Real X_ac(fixed = true, start = 1.01593) "0.414792";
    Real X_h2(fixed = true, start = 0.463351) "0.1845";
    //Particulate substrate
    Real X_c(fixed = true, start = 0.0) "0.188523943307974; 0.29881";
    Real X_i(fixed = true, start = 45.1488) "14.105";
    Real X_ch(fixed = true, start = 1.09422) "0.0276983";
    Real X_pr(fixed = true, start = 0.890377) "2.706355984";
    Real X_li(fixed = true, start = 0.325233) "0.00093818";
    //Soluble substrate
    Real S_i(fixed = true, start = 2.06057e-08);
    Real S_su(fixed = true, start = 0.0216284);
    Real S_aa(fixed = true, start = 0.0545847);
    Real S_fa(fixed = true, start = 0.0414486);
    Real S_va(fixed = true, start = 0.00201259) "8/10**";
    Real S_bu(fixed = true, start = 0.0031565) "8/10**";
    Real S_pro(fixed = true, start = 0.0156237) "8/10**";
    Real S_ac(fixed = true, start = 0.880519) "8/10**";
    Real S_vam(fixed = true, start = 0.0020104) "8/10";
    Real S_bum(fixed = true, start = 0.00315335) "8/10";
    Real S_prom(fixed = true, start = 0) "8/10";
    Real S_acm(fixed = true, start = 0.879755) "8/10";
    //Inorganic soluble components
    Real S_h2(fixed = true, start = 4.11532e-07);
    Real S_ch4(fixed = true, start = 0.0474429);
    Real S_ic(fixed = true, start = 0.332713) "8/10";
    Real S_in(fixed = true, start = 0.242044) "8/10";
    Real S_ip(fixed = true, start = 0.00659511) "8/10";
    Real S_cat(fixed = true, start = 0.144689);
    Real S_ca(fixed = true, start = 0.000238053);
    Real S_mg(fixed = true, start = 8.75745e-05);
    Real S_an(fixed = false, start = 0.0197599);
    Real S_hco3(fixed = false, start = 0.323025) "8/10";
    Real S_nh3(fixed = true, start = 0.0187221) "8/10";
    Real S_nh4(fixed = false, start = 0.223322) "8/10";
    Real S_hpo4(fixed = false, start = 0.005365) "8/10";
    Real S_h2po4(fixed = true, start = 0.00123002) "8/10";
    Real S_po4(fixed = true, start = 1.22302e-08) "8/10";
    Real S_co2(fixed = true, start = 0.0096877) "8/10";
    Real pH(fixed = false, start = 7.11);
    Real S_h(fixed = true, start = 1.51014e-08) "8/10";
    Real S_oh(fixed = false, start = 1.58449e-06) "8/10";
    Real Theta(fixed = false, start = 0.02);
    //Gas components
    Real S_gas_h2(fixed = false, start = 1.88676e-05);
    Real S_gas_ch4(fixed = true, start = 1.48839);
    Real S_gas_co2(fixed = true, start = 0.0144672);
    Real p_gas_h2(fixed = false, start = 1.5e-05);
    ...
    Types.MolarDensity_M X_hap(fixed = true, start = 1e-6, nominal = 1e-2) "mol/L";
    ...
    Types.MolarDensity_M a_oh(nominal = 1e-8) "mol/L";
    Real rp1;
    Real rp2;
    Real rp3 (fixed=false, nominal = 1e-1);
    Modelica.SIunits.PerUnit SI_stru(nominal = 1);
    Modelica.SIunits.PerUnit SI_acp(nominal = 1);
    Modelica.SIunits.PerUnit SI_hap(nominal = 1);
    Types.MolarDensity_M I(fixed=false, start=3.45389E-01, nominal = 1e-1) "mol/L";
    Real g_nh4;
    Real g_po4;
    Real g_mg;
    Real g_ca;
    ...
    Types.MolarDensity_M_Ksp_acp Ksp_hap(nominal = 1e-44);
    annotation(
...
//entra come totale o come ione? Analisi controioni? Trovo S_cat togliendo i cationi noti.
    ...
    equation
//general inputs from Biernacki
      Slurry_Out.Q = -190 "m3/d";
      TS_in2 = 90 "??; gTS/kg";
      VS_in2 = 0.85 * TS_in2 "??, gVS/kg";
      pH_in2 = 7.2 "-";
      Alk_in2 = 17500 "??, mgCaCO3/L";
//not used here
      Ammonium_in2 = 700 "mgN/L";
      Fosfates_in2 = 713 "mgP/L";
...
//Computation of variables S_ac, S_pro, S_bu, S_va (Weinrich)
      Slurry_Out.S_ac = 0.027 "gCOD/L";
      Slurry_Out.S_pro = 0.010 "gCOD/L";
      Slurry_Out.S_bu = 0.002 "gCOD/L";
      Slurry_Out.S_va = 0.002 "gCOD/L";
//Computation of variables S_su, S_aa, S_fa, S_i
      Slurry_Out.S_su = 0.016 "gCOD/L";
      Slurry_Out.S_aa = 0.008 "gCOD/L";
      Slurry_Out.S_fa = 0.000 "gCOD/L";
      Slurry_Out.S_i = 0.027 "gCOD/L";
//Computation of physical properties
...
//Computation of variables X_ch, X_pr, X_li (gCOD/L; Biernacki)
      Slurry_Out.X_i = 12.332;
      Slurry_Out.X_pr = 9.543;
      Slurry_Out.X_li = 12.768;
      Slurry_Out.X_ch = 9.082;
      Slurry_Out.X_c = 0;
...
//Slurry_Out.S_ic = S_hco3_in2 * (S_h_in2 + Ka_co2_in2) / Ka_co2_in2 "mol/L";
      S_hco3_in2 = Slurry_Out.S_ic / ((S_h_in2 + Ka_co2_in2) / Ka_co2_in2) "mol/L";
      Slurry_Out.S_ic = 384 / 12 / 1000 "mol/L";
...
//Slurry_Out.S_an = S_an_input2 "mol/L";
      Slurry_Out.S_an = 0.00001 "mol/L";
      Slurry_Out.S_cat = (-S_nh4_in2) - S_h_in2 - 2 * Slurry_Out.S_ca - 2 * Slurry_Out.S_mg + Slurry_Out.S_an + S_hco3_in2 + S_oh_in2 + S_ac_ion_in2 + S_pro_ion_in2 + S_bu_ion_in2 + S_va_ion_in2 + 2 * S_hpo4_in2 + S_h2po4_in2 + 3 * S_po4_in2 + 0.021 "mol/L";
    //Slurry_Out.S_cat = 0.0 "0.005 + 0.003 - 0.029 mol/L";
...
//entra come totale o come ione? Analisi controioni? Trovo S_cat togliendo i cationi noti.
    ...
    model Feeding_Tank
      ...
      ADM1_P.Interfaces.Partial Partial_Out annotation(
        Placement(visible = true, transformation(origin = {78, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {74, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Real CODin;
      Real CODout;
    equation
...
//Verify balance
    ...
    model Digester
      ...
      ADM1_P.Interfaces.Partial Partial_In annotation(
        Placement(visible = true, transformation(origin = {-74, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-76, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    equation
//MMP submodel
      I = if noEvent(0.5 * (S_ca * z_ca ^ 2 + S_po4 * z_po4 ^ 2 + S_nh4 * z_nh4 ^ 2 + S_mg * z_mg ^ 2 + S_hpo4 * 2 ^ 2 + S_h2po4 * 1 ^ 2 + S_hco3 * 1 ^ 2 + S_cat * 1 ^ 2 + S_an * 1 ^ 2 + 1^2*(S_acm / Ac_conv + S_prom / Pro_conv + S_bum / Bu_conv + S_vam / Va_conv))) < 0 then 0.2 else 0.5 * (S_ca * z_ca ^ 2 + S_po4 * z_po4 ^ 2 + S_nh4 * z_nh4 ^ 2 + S_mg * z_mg ^ 2 + S_hpo4 * 2 ^ 2 + S_h2po4 * 1 ^ 2 + S_hco3 * 1 ^ 2 + S_cat * 1 ^ 2 + S_an * 1 ^ 2 + 1^2*(S_acm / Ac_conv + S_prom / Pro_conv + S_bum / Bu_conv + S_vam / Va_conv));
      ...
      g_oh = 10 ^ (-0.5 * (-1) ^ 2 * (I ^ 0.5 / (1 + I ^ 0.5) - 0.3 * I));
      a_ca = g_ca * S_ca;
      a_po4 = g_po4 * S_po4;
      a_mg = g_mg * S_mg;
      a_nh4 = g_nh4 * S_nh4;
      ...
      Ksp_hap = 10 ^ (-pKsp_hap) * exp(deltaH0_Ksp_hap / (R * 100) * (1 / T_ref - 1 / T_op));
      ...
      SI_hap = log(a_ca ^ 5 * a_po4 ^ 3 * a_oh / Ksp_hap) / abs(log(a_ca ^ 5 * a_po4 ^ 3 * a_oh / Ksp_hap));
      ...
      rp3 = if noEvent(X_hap<0 and SI_hap<0) then 0.0 else kcryst_hap * abs(X_hap) * ((a_ca ^ 5 * a_po4 ^ 3 * a_oh / Ksp_hap) ^ (1 / 9) - 1) ^ 2 * SI_hap;
      24 * 3600 * der(X_acp) = FeedMix_In.Q / V_liq * (-X_acp) + rp1;
      24 * 3600 * der(X_stru) = FeedMix_In.Q / V_liq * (-X_stru) + rp2;
      24 * 3600 * der(X_hap) = FeedMix_In.Q / V_liq * (-X_hap) + rp3;
//
...
//Soluble matter
      ...
      24 * 3600 * der(S_ip) = FeedMix_In.Q / V_liq * (FeedMix_In.S_ip - S_ip) + P_li * (r4_1 + r4_2 + r4_3) - Y_su * P_bac * r5 - Y_aa * P_bac * r6 - Y_fa * P_bac * r7 - Y_c4 * P_bac * r8 - Y_c4 * P_bac * r9 - Y_pro * P_bac * r10 - Y_ac * P_bac * r11 - Y_h2 * P_bac * r12 + (P_bac - P_i * f_xi_xb - P_li * f_li_xb) * (r13 + r14 + r15 + r16 + r17 + r18 + r19) - 2 * rp1 - rp2 - 3*rp3;
//
//Biomasses
...
//Cations and anions
      ...
      24 * 3600 * der(S_ca) = FeedMix_In.Q / V_liq * (FeedMix_In.S_ca - S_ca) - 3 * rp1 -5*rp3;
      ...
      24 * 3600 * der(S_oh) = -Ka_h2o*convKa*der(S_h)/S_h^2 - rp3; //? Alternative: direcly -X_hap in the charge balance
...
//Alk = (Digestate_In.S_hco3 + Digestate_In.S_oh + Digestate_In.S_acm / Ac_conv + Digestate_In.S_prom / Pro_conv + Digestate_In.S_bum / Bu_conv + Digestate_In.S_vam / Va_conv) * 50 * 1000 "Alkalinity as mgCaCO3/L";
  ...
  class SynopticModel
    ...
    ADM1_P.BlockLibrary.Feeding_Tank feeding_Tank annotation(
      Placement(visible = true, transformation(origin = {-66, 20}, extent = {{-22, -22}, {22, 22}}, rotation = 0)));
    ADM1_P.BlockLibrary.Digester digester annotation(
      Placement(visible = true, transformation(origin = {11, 21}, extent = {{-25, -25}, {25, 25}}, rotation = 0)));
  ...
  connect(digester.Biogas_Out, Gas_Meter.Biogas_In) annotation(
      Line(points = {{22.5, 40}, {22.5, 56}, {46, 56}}));
  connect(digester.T_op, Probe_T.y_T) annotation(
      Line(points = {{-7.5, 6}, {-13, 6}, {-13, -36}}, color = {0, 0, 127}));
  ...
  connect(digester.Digestate_Out, Discharge.Digestate_In) annotation(
      Line(points = {{30, 4.5}, {42.5, 4.5}, {42.5, 6}, {47, 6}}));
  connect(PID_Pgas.y, digester.u) annotation(
      Line(points = {{6, 72}, {12, 72}, {12, 44.5}}, color = {0, 0, 127}));
